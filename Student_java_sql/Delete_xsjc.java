 ...
 * @author guowh
 */
public class Delete_xsjc extends JFrame {
    ...
    private JButton button_shanchu_jl = new JButton("删除");
    private JButton button_guanbi = new JButton("关闭");
    private JButton button_chakan_cf = new JButton("查看");
    private JButton button_shanchu_cf = new JButton("删除");
    ...
    private void myWindowListener() {
        ...
        //奖励删除事件监听
        button_shanchu_jl.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
        ...
        //惩罚删除监听
        button_shanchu_cf.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
