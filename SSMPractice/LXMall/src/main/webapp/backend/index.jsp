...
<section class="rt_wrap content mCustomScrollbar">
    <p style="font-size: xx-large">这是首页啊</p>
    <!--<div class="rt_content">
        &lt;!&ndash;开始：以下内容则可删除，仅为素材引用参考&ndash;&gt;
        ...
        <p style="color:red;font-size:16px;font-weight:bold;text-align:center;margin:8px 0;background:#FFC;padding:8px;">
            这里是相关常用性样式预设，具体根据内容版块调整，列表添加字段注意考虑笔记本屏幕显示；<br/>此页面仅为样式参考，程序对接可移除，具体布局根据项目内容而定<br/>注意保留rt_content.parent<br/>常用<b
                style="color:#090; text-decoration:underline">“统计图”</b><b style="color:#090; text-decoration:underline">“Tab切换”</b><b
                ...
                style="color:#090; text-decoration:underline">“HTML5canvas特效”</b>等等，具体根据实际需求添加修改追加！</p>
        &lt;!&ndash;统计图&ndash;&gt;
        ...
        <section class="pop_bg">
            <div class="pop_cont">
                ...
                &lt;!&ndash;以pop_cont_text分界&ndash;&gt;
                <div class="pop_cont_text">
                    这里是文字性提示信息！
                </div>
                &lt;!&ndash;bottom:operate->button&ndash;&gt;
                <div class="btm_btn">
