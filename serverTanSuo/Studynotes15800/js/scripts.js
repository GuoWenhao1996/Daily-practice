...
function getNowFormatDate() {
    ...
    var alldate = Math.ceil((currentdate - startdate) / 86400000);
    document.getElementById("sitetime").innerHTML = alldate;
    var allarticle = Math.ceil(alldate / 7);
    if (alldate % 7 == 0)
        allarticle = allarticle + 1;
    document.getElementById("articlecount").innerHTML = allarticle;
}